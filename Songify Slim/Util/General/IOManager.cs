...
internal static class IoManager
{
        ...
        try
        {
            ...
            else
            {
                ...
                webClient.DownloadFileCompleted += (sender, e) =>
                {
                    ...
                    {
                        Util.General.AppShellBridge.Current?.StopCanvas();
                    });
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                Util.General.AppShellBridge.Current?.SetCanvas(canvasPath);
            });
        }
        catch (Exception ex)
        {
    ...
    public static async Task DownloadCover(string cover, string coverPath)
    {
        ...
        try
        {
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                Util.General.AppShellBridge.Current?.SetCoverImage(coverPath);
            });
        }
        catch (Exception ex)
        {
